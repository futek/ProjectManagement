...
public class SystestEditProjectEndDate {
	...
	public void testA() throws IOException {
		appUITester.expect("New end week year: ").write("").expect("Invalid week year. Try again.");
	}

	@Test
	public void testB() throws IOException {
		appUITester.expect("New end week year: ").write("abc").expect("Invalid week year. Try again.");
	}

	@Test
	public void testC() throws IOException {
		appUITester.expect("New end week year: ").write("2012").expectNothing();
		appUITester.expect("New end week number: ").write("").expect("Invalid week number. Try again.");
	}

	@Test
	public void testD() throws IOException {
		appUITester.expect("New end week year: ").write("2012").expectNothing();
		appUITester.expect("New end week number: ").write("abc").expect("Invalid week number. Try again.");
	}

	@Test
	public void testE() throws IOException {
		appUITester.expect("New end week year: ").write("2012").expectNothing();
		appUITester.expect("New end week number: ").write("0").expect("Invalid week number. Try again.");
	}

	@Test
	public void testF1() throws IOException {
		appUITester.expect("New end week year: ").write("2012").expectNothing();
		appUITester.expect("New end week number: ").write("1").expectNothing(); // Success!
	}

	@Test
	public void testF2() throws IOException {
		appUITester.expect("New end week year: ").write("2012").expectNothing();
		appUITester.expect("New end week number: ").write("52").expectNothing(); // Success!
	}

	@Test
	public void testG() throws IOException {
		appUITester.expect("New end week year: ").write("2012").expectNothing();
		appUITester.expect("New end week number: ").write("53").expect("Invalid week number for week year 2012. Try again.");
	}

	@Test
	public void testH() throws IOException {
		appUITester.expect("New end week year: ").write("2012").expectNothing();
		appUITester.expect("New end week number: ").write("54").expect("Invalid week number. Try again.");
	}

	@Test
	public void testI() throws IOException {
		appUITester.expect("New end week year: ").write("2015").expectNothing();
		appUITester.expect("New end week number: ").write("").expect("Invalid week number. Try again.");
	}
	...
	public void testM() throws IOException {
		appUITester.expect("New end week year: ").write("2015").expectNothing();
		appUITester.expect("New end week number: ").write("53").expectNothing(); // Success!
	}
